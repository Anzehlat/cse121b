...
},
{
    ...
    "area": 42657,    "imageUrl": "https://content.churchofjesuschrist.org/templesldsorg/bc/Temples/photo-galleries/cedar-city-utah/400x225/Cedar-City-1978603.jpg"
},
{
...
/* Declare and initialize the global templesElement variable */
...
const displayTemples = (templeList) => {
    templeList.forEach((temple) => {
        ...
        const dedicatedDate = temple.dedicated;
        ...
        articleElement.innerHTML = `
            ...
            <p><strong>Dedicated:</strong> ${dedicatedDate}</p>
            <p><strong>Area:</strong> ${area} square feet</p>
...
/* reset Function */
const reset = () => {
    const articlesToRemove = document.querySelectorAll('#temples article');
